...
export { default as MyWishlist } from "./account-view/MyWishlist.vue";
export { default as MyInfo } from "./account-view/MyInfo.vue";
export { default as MyAds } from "./account-view/MyAds.vue";
